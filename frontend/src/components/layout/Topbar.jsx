...
export default function Topbar({ 
  ...
  return (
    <header className="fixed top-0 left-64 right-0 z-50 h-16 bg-surface/60 backdrop-blur-xl border-b border-white/10 px-container-padding flex justify-between items-center shadow-sm">
      <div className="flex items-center gap-6">
        <div className="relative group">
          ...
          <input 
            className="bg-white/5 border border-white/10 rounded-full pl-10 pr-4 py-1.5 w-80 text-body-md focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all text-on-surface placeholder:text-on-surface-variant/30" 
      ...
      <div className="flex items-center gap-4">
        <button className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-white/5 transition-all text-on-surface-variant cursor-pointer border-none bg-transparent">
